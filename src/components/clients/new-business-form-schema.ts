...
export const newBusinessFormSchema = z
  .object({
    ...
    // Client Details
    title: z.enum(['Mr', 'Mrs', 'Miss', 'Dr', 'Prof', 'Hon']).default('Mr'),
    ...
    nationalIdType: z.enum(idTypes).default('National ID'),
    ...
    religion: z.enum(['Christian', 'Muslim', 'Traditional', 'Other']).default('Christian'),
    ...
    policyTerm: z.coerce.number().positive('Policy term must be a positive number.').default(1),
    premiumTerm: z.coerce.number().positive('Premium term must be a positive number.').default(1),
    sumAssured: z.coerce
      .number()
    ...
    paymentFrequency: z.enum(['Monthly', 'Annually', 'Quarterly', 'Bi-Annually']).default('Monthly'),
    ...
    accountType: z.enum(['Current', 'Savings', 'Other']).default('Savings'),
    ...
    alcoholBeer: alcoholDetailSchema.optional().default({ consumed: false, averagePerWeek: '', notes: '' }),
    alcoholWine: alcoholDetailSchema.optional().default({ consumed: false, averagePerWeek: '', notes: '' }),
    alcoholSpirits: alcoholDetailSchema.optional().default({ consumed: false, averagePerWeek: '', notes: '' }),
    reducedAlcoholMedicalAdvice: reducedAlcoholReasonSchema.optional().default({ reduced: 'no', notes: '' }),
    reducedAlcoholHealthProblems: reducedAlcoholReasonSchema.optional().default({ reduced: 'no', notes: '' }),
    ...
    tobaccoCigarettes: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '' }),
    tobaccoCigars: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '' }),
    tobaccoPipe: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '' }),
    tobaccoNicotineReplacement: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '' }),
    tobaccoEcigarettes: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '' }),
    tobaccoOther: tobaccoDetailSchema.optional().default({ smoked: false, avgPerDay: '', avgPerWeek: '', otherType: '' }),
    ...
    testedPositiveFor: viralInfectionDetailSchema.optional().default({ hiv: false, hepB: false, hepC: false }),
    awaitingResultsFor: viralInfectionDetailSchema.optional().default({ hiv: false, hepB: false, hepC: false }),
